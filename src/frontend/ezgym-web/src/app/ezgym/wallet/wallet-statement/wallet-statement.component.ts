...
import { WalletModel, WalletReceiptModel } from '../../core/models/wallet.model';
...
export class WalletStatementComponet extends Store<ComponentState> implements OnInit {
    ...
    constructor(
        ...
        this.gymManagementStore.store$
            .pipe(
                filter(state => state.wallet != null),
